...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { description: @holiday.description, flight_price: @holiday.flight_price, location: @holiday.location, photo: @holiday.photo } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { description: @holiday.description, flight_price: @holiday.flight_price, location: @holiday.location, photo: @holiday.photo } }
